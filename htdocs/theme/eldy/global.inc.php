...
.dataTables_length label select {
    ...
    <?php if (empty($conf->global->THEME_ADD_BACKGROUND_ON_INPUT)) {
        ?>border<?php echo empty($conf->global->THEME_SHOW_BORDER_ON_INPUT) ? '-bottom': '';
...
@media only screen and (max-width: <?php echo empty($conf->global->THEME_ELDY_WITDHOFFSET_FOR_REDUC3) ? round($nbtopmenuentries * 47, 0) + 130 : $conf->global->THEME_ELDY_WITDHOFFSET_FOR_REDUC3; ?>px)
...
@media only screen and (min-width: 768px) and (max-width: <?php echo empty($conf->global->THEME_ELDY_WITDHOFFSET_FOR_REDUC3) ? round($nbtopmenuentries * 47, 0) + 130 : $conf->global->THEME_ELDY_WITDHOFFSET_FOR_REDUC3; ?>px)
...
.login_table {
    ...
    <?php if ( !empty($conf->global->MAIN_LOGIN_BACKGROUND)) {
...
div.ui-tooltip {
    max-width: <?php print dol_size(600, 'width');
    ?>px !important;
}
...
div#tmenu_tooltip .select2-container--default .select2-selection--single {
    width: 30rem;
}

div#tmenu_tooltip span.select2.select2-container.select2-container--default {
...
@media only screen and (max-width: <?php echo empty($conf->global->THEME_ELDY_WITDHOFFSET_FOR_REDUC1) ? round($nbtopmenuentries * 90, 0) + 340 : $conf->global->THEME_ELDY_WITDHOFFSET_FOR_REDUC1; ?>px)
