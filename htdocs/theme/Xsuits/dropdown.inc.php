...
/* <style type="text/css">
dont remove this line it's an ide hack */
...
.open>.dropdown-bookmark,
.open>.dropdown-quickadd,
.open>.dropdown-menu,
.dropdown dd ul.open {
    display: block;
}
...
div#topmenu-global-search-dropdown a::after,
div#topmenu-quickadd-dropdown a::after,
div#topmenu-bookmark-dropdown a::after {
    display: none;
}
...
.topnav .user-menu .dropdown-menu>.user-header {
    min-height: 100px;
    padding: 10px;
    text-align: center;
    white-space: normal;
...
#topmenu-quickadd-dropdown .dropdown-menu>.bookmark-body,
#topmenu-quickadd-dropdown .dropdown-body,
#topmenu-bookmark-dropdown .dropdown-menu>.bookmark-body,
#topmenu-bookmark-dropdown .dropdown-body {
    max-height: 60vh;
    /* fallback for browsers without support for calc() */
...
.dropdown-item:focus,
.dropdown-item:focus span::before {
